   <header class="bg-white header header-md navbar navbar-fixed-top-xs box-shadow">
      <div class="navbar-header aside-md dk">
        ...
        <a href="mainscreen" class="navbar-brand">
          <img src="images/logo.png" class="m-r-sm" alt="scale">
          <span class="hidden-nav-xs">Phoenix RL <?php if(MConfig::$config_server_type == "dev") echo "DEV"; ?></span>
        </a>
...
-->        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            ...
            <?php echo $_SESSION['user']->full_name; ?> <b class="caret"></b>
          </a>
          <ul class="dropdown-menu animated fadeInRight">            
            ...
            <li class="divider"></li>
            <li>
              <a href="elements/modal_logout" data-toggle="ajaxModal" >Logout</a>
            </li>
          </ul>
        </li>
      </ul>      

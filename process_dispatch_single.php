<?php 
    ...
    if(isset($post)){
        ...
        for($i = 1; $i <= $post['qty']; $i++){


            //find the Element
            $element = $database->selectSingleClass('tblContainerElements', "MContainerElement", array('skuId' => $item->id, 'active' => '1', 'containerId' => $post['containerId']));

            $update = array();  
            $update['dispatch_date'] = date('Y-m-d H:i:s');
            $update['dispatch_by'] = $_SESSION['user']->id;
            $update['active'] = 0;
            $update['salesPrice'] = $post['price'];


            $database->update('tblContainerElements', $update, array('id' => $element->id));
              ...
              <section class="vbox">
                <section class="scrollable padder">              
                  <section class="row m-b-md">
                    <div class="col-sm-6">
                      <h3 class="m-b-xs text-black">Process - Dispatch single item</h3>
                    </div>
                  </section>
                  <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="panel-body">
                        ...
                        <div class="tab-content">
                          <div class="tab-pane" id="step1">
                            ...
                            <p>Qty</p>
                            <input id="qty" name="qty" type="number" value="1" min="1" class="form-control" data-trigger="change" data-required="true"  minlength="1" value="1"> 
                          </div>
                          ...
                          <div class="tab-pane" id="step3">
                            <p>Item price</p>
                              <input id="price" name="price" type="text" class="form-control" data-trigger="change" data-required="true" minlength="1">                              
                            <p></p>  
                              <button type="submit" class="btn btn-lg btn-danger">Confirm</button>
                          </div>
...
<script src="js/wizard/dispatch_single.js"></script>

              ...
              <section class="vbox">
                <section class="scrollable padder">              
                  <section class="row m-b-md">
                    <div class="col-sm-12">
                      <h3 class="m-b-xs text-black">eBay listing for <?php echo $item->title; ?></h3>
                    </div>
                  </section>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="doc-buttons">
                                <a href="product_file_generate_ebay_layout_preview?cmd=ebay&val_a=<?php echo $item->accessId; ?>" target="_blank" class="btn btn-s-md btn-info">Preview</a>
                                <button class="btn btn-s-md btn-success" data-clipboard-action="copy" data-clipboard-target="#to_copy" id="copy_button">Copy to clipboard</button>
                            </div>
                        </div>
                    </div>                    
                  <div class="row">
...
<!--- BIG IMAGE --->
<img src="<?php echo 'http://phoenixrl.com/assets/picture_tracking.php?cmd=' . $item->sku; ?>" >
</div></div>
<!-- thumbnails (5 max) -->
